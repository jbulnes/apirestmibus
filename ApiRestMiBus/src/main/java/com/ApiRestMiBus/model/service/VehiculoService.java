    ...
    public Page<VehiculoDTO> findAll(Pageable pageable){
        ...
        return vehiculoRepository.findAll(pageable)
                .map(vehiculo -> new VehiculoDTO(
                        ...
                        vehiculo.getImei(),
                        vehiculo.getSim(),
                        vehiculo.getVencimientoRevisionTecnica() != null ? vehiculo.getVencimientoRevisionTecnica().format(formatter) : null,
                        ...
                        vehiculo.getVencimientoSoat() != null ? vehiculo.getVencimientoSoat().format(formatter) : null,
                        vehiculo.getNumeroPolizaSeguro(),
                        vehiculo.getVencimientoPoliza() != null ? vehiculo.getVencimientoPoliza().format(formatter) : null,
